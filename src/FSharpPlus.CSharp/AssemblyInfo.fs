...
[<assembly: AssemblyTitleAttribute("FSharpPlusCSharp")>]
[<assembly: AssemblyProductAttribute("FSharpPlusCSharp")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FSharpPlusCSharp"
    let [<Literal>] AssemblyProduct = "FSharpPlusCSharp"
